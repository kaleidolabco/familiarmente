...
export default function ApplicationsList({ rows = [], controllerPage, controllerRowsPerPage, changePage, changeRowsPerPage, totalElements }) {
                            ...
                            return (
                                ...
                                >
                                    <TableCell
                                        ...
                                        sx={{ p: 0, m: 0 }}
                                    >
                                        <ApplicationCard applicationData = {row} />
                                    </TableCell>
                                </TableRow>
                            );
                        })}
